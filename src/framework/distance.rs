...
/// grain_size recommended range: [15.0, 25.0]
/// angle_mult recommended range: [10.0, 50.0]
// pub fn wood_grain(
//     x1: f32,
//     y1: f32,
//     x2: f32,
...
//     let distance = ((x2 - x1).powi(2) + (y2 - y1).powi(2)).sqrt();
//     let angle = (y2 - y1).atan2(x2 - x1);
//     (distance / grain_size).sin() + (angle * 5.0).sin() * angle_mult
// }
// pub fn wood_grain(
//     x1: f32,
//     y1: f32,
...
//     let distance = ((x2 - x1).powi(2) + (y2 - y1).powi(2)).sqrt();
//     let angle = (y2 - y1).atan2(x2 - x1);
//     (distance / grain_size).sin() * distance + (angle * 5.0).sin() * angle_mult
// }
pub fn wood_grain(
    x1: f32,
    y1: f32,
